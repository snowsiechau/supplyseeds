...
class Storeviews extends Apiabstract
{
    ...
    public function show()
    {
        ...
        $this->addCustomizationInfo($additionInfo);
    ...
    private function addCustomizationInfo(&$additionInfo) {
        $additionInfo['customization']['areas'] = $this->simiObjectManager->get('Simi\Simiaddress\Helper\Address')->getAreas();
    }
}
