...
class Customer extends \Magento\Framework\Model\AbstractModel
{
    ...
    public function updateProfile($data)
    {
        ...
        $customerData = [
            ...
            'email'     => $data->email,
            'simi_phone'     => $data->simi_phone,
        ];

        if (isset($data->simi_phone)) {
            $customer->setSimiPhone($data->simi_phone);
        }
    ...
    private function _createCustomer($data)
    {
        ...
        if (isset($data->simi_phone)) {
            $customer->setData('simi_phone', $data->simi_phone);

            $customer->setCustomAttribute('simi_phone', $data->simi_phone);
        } else {
            $customer->setData('simi_phone', '0000000000');

            $customer->setCustomAttribute('simi_phone', '0000000000');
